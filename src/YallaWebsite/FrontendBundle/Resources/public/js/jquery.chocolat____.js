(function (factory) {
    ...
    var defaults = {
        ...
        imageSelector2     : '.chocolat-image-data',
        className         : '',
    ...
    function Chocolat(element, settings) {
        ...
        this.element.find(this.settings.imageSelector).each(function () {
            that.settings.images.push({
                ...
                //title  : $(this).getElementsByTagName('p'),
                src    : $(this).attr('href'),
                height : false,
                width  : false
            });
        });
        var l = that.settings.images.length;
        var m = 0;
        this.element.find(this.settings.imageSelector2).each(function () {
            that.settings.images[m].title = $(this);
            $(this).remove();
            m++;
        });
